...
helm.sh/chart: {{ include "monitoring-agent.chart" . }}
{{ include "monitoring-agent.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "monitoring-agent.selectorLabels" -}}
